...
This module is a ported version of John Loyd's implementation: http://www.cs.ubc.ca/~lloyd/java/quickhull3d.html
...
Constructors:
	quickHull.new(points)
		> Creates a new quickHull object from a table filled with Vector3's (the point cloud).
...
Methods:
	quickHull:build()
		> Builds the hull on a given quickHull object.
	quickHull:collectFaces(skipTriangulation)
		> Returns a table of indices for the quickHull.vertices table.
...
You might also notice I've included two other modules, draw and vertices. These are also not needed for the quickHull module to work and can be deleted.
...
The vertices module is much more useful in the context of quickhull. It will take the basic shapes: wedges, ball, cylinder, etc and return their vertices.
...
https://www.roblox.com/library/447335959/quickhull-lua
--]]

local vertexList = require(script:WaitForChild("vertexList"));
local vertex = require(script:WaitForChild("vertex"));
local face = require(script:WaitForChild("face"));
